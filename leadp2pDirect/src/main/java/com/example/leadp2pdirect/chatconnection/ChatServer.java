...
import com.example.leadp2pdirect.textmessage.ClientInfo;
import com.example.leadp2pdirect.textmessage.JoinMessage;
import com.example.leadp2pdirect.textmessage.LeaveMessage;
        ...
        public void run() {
            ...
            try {
                ...
                while (!(ChatServer.this.ShouldStop || message == null)) {
                    ...
                    Log.e("Kevin", message.substring(5));
